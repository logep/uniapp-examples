...
public interface AnyAttrService {
    ...
    public List<AnyattrDO> getList(
            @HttpParam(name = "id", type = HttpParamType.COMMON, description = "任意ID") Long id,
            @HttpParam(name = "type", type = HttpParamType.COMMON, description = "任意数据type") String type) throws ServiceException;
